              ...
              <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                  ...
                  <div className="card shadow-sm">
                    ...
                    <div className="card-body">
                      <p className="card-text text-body-secondary">
                        ...
                        fundraising consultant to top colleges across the
                        country.
                      </p>
                      <div className="d-flex justify-content-between align-items-center">
                        <div className="btn-group">
                ...
                <div className="col">
                  <div className="card shadow-sm">
                    ...
                    <div className="card-body">
                      <p className="card-text text-body-secondary">
                        Freshly forty-five, Aja James knows that her life is
                        good, complete with a loving, wealthy husband,
                        well-adjusted children, and a beautiful home.
                      </p>
                      <div className="d-flex justify-content-between align-items-center">
                        <div className="btn-group">
                          <button
                  ...
                  <div className="card shadow-sm">
                    ...
                    <div className="card-body">
                      <p className="card-text text-body-secondary">
                        ...
                        from Miami and Port-au-Prince to a small unnamed
                        country.
                      </p>
                      <div className="d-flex justify-content-between align-items-center">
                        <div className="btn-group">
                ...
                <div className="col">
                  <div className="card shadow-sm">
                    ...
                    <div className="card-body">
                      <p className="card-text text-body-secondary">
                        Among its residents—wildly spanning decades,
                        perspectives, and species—are David Sherman, a
                        struggling musician.
                      </p>
                      <div className="d-flex justify-content-between align-items-center">
                        <div className="btn-group">
